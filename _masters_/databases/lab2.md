...
--2. Написать оператор Select который формирует отчет обо всех накладных и спецификации, относящиеся к ним. (Шапка должна включать номер товарной накладной дату формирования и название номенклатуры, количество, цену.) Создать Vew
--  3. Написать оператор Select который формирует имеющих спецификации.
--4. Написать оператор Select который формирует имеющих спецификацию.
--5. Написать оператор Select который формирует спецификации.
--6. Написать оператор Select который формирует имеющих максимальную стоимость.
